...
### Before you begin
1. Start RStudio in the usual way. Open your `NES2303` project from the main menu by clicking on **File -> Open project...** and navigate to your NES2303 project file and open it. Check that the word "None" has been replaced by "NES2303" in the project listing at the top right of the RStudio window.
2. From the main menu click "File -> New file -> R Script"
3. Save your script, e.g. call it `practical4.R`

### Data for this practical
Go to Canvas and download the **lichen.csv**,  **sppcount.csv** and **beetle.csv** data sets. Start up your "File Explorer" and move the files from your **Downloads** folder to either your **NES2303** folder, or your **NES2303/Data** folder depending on your preferences.
...
Now import the three .csv files you downloaded from Canvas into R, `lichen.csv`, `sppcount.csv` and `beetle.csv`. Add the following code, plus suitable comments, to your `practical4.R` script. **Note**: The code below assumes you have a `Data` subfolder inside your `NES2303` folder. If you have stored your CSV files directly in your `NES2303` folder then omit the `Data/` from below.
