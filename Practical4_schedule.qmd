...
You will recall that linear models assume your data (or more precisely, the noise or errors around your fitted line) come from a normal or Gaussian distribution. The easiest way to check this is via a QQ plot. Remember to click in the Console window (bottom left) and hit the big 'Enter' key :
